            ...
            <div className="container mx-auto p-6 md:p-0">
                ...
                <div className="w-full mt-4 flex items-center justify-center" data-aos="fade-right">
                    ...
                    <div className="absolute m-2 mr-6 gap-2 flex flex-col justify-center items-center">
                        ...
                        <h4 className="bg-yellow-400 rounded-md py-1 font-semibold px-2 mr-[10dvh] text-xs md:text-sm lg:text-base md:mx-32">Fast food and cold drinks that will make you come back for more. Designed to satisfy your cravings. Whether you’re in the mood for a burger, fries, or a refreshing drink, we’ve got you covered</h4>
                    </div>
                </div>
            </div>
            <Footer></Footer>
